...
public class ExtractingBusStopData {

    private final String USER_AGENT = "Mozilla/5.0";

    public static void main(String[] args) throws Exception, FileNotFoundException {

        ExtractingBusStopData http = new ExtractingBusStopData();

        PrintWriter printer = new PrintWriter(new File("web\\resources\\BusStop.csv"));
        printer.write("BusStopCode,RoadName,Description,Latitude,Longitude\n");
        int index = 0;
        ...
        while (array.length() > 0) {
            for (int i = 0; i < array.length(); i++) {
                ...
                String BusStopCode = p.getString("BusStopCode");
                String RoadName = p.getString("RoadName");
...
// HTTP GET request
    private StringBuffer sendGet(int dataIndex) throws Exception {
        ...
        String url = "http://datamall2.mytransport.sg/ltaodataservice/BusStops?$skip=" + dataIndex;
